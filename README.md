...
<pre> ``` projeto-Prova01-progWeb/ │ ├── index.html # Página inicial do site │ ├── src/ │ ├── css/ │ │ └── estilos.css # Arquivo de estilos principais │ │ │ ├── js/ │ │ └── script.js # Lógica de autenticação e interações │ │ │ ├── imagens/ │ │ └── usuario.png # Foto fictícia do usuário (exemplo) │ │ │ └── paginas/ │ ├── login.html # Página de login │ └── cadastro.html # Página de cadastro │ └── README.md # Documento descritivo do projeto ``` </pre>
